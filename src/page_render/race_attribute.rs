                ...
                .body(|mut body| {
                        ...
                        .enumerate()
                    {
                        body.row(20., |mut row| {
                            ...
                            row.col(|ui| {
                                ui.add(DragValue::new(&mut race_attribute.id).speed(0).update_while_editing(false));
                            });
                            row.col(|ui| {
                                ui.text_edit_singleline(&mut race_attribute.icon);
                            });
                            row.col(|ui| {
                                ui.add(DragValue::new(&mut race_attribute.name_id).speed(0).update_while_editing(false));
                            });
                            row.col(|ui| {
                                ui.add(DragValue::new(&mut race_attribute.desc_id).speed(0).update_while_editing(false));
                            });
                        });
                    }
                });
